...
const securityStatusItemVariants = cva("border rounded-md ring-4", {
  variants: {
    variant: {
      success: "border-success bg-success text-white ring-success/3",
      warning: "border-warning bg-warning text-white ring-warning/3",
      destructive: "border-destructive bg-destructive text-white ring-destructive/3",
    },
  },
  defaultVariants: {
    variant: "success",
...
export default function SecurityStatus({ statuses }: SecurityStatusProps) {
  return (
    <DashboardCard title="SECURITY STATUS" intent="success" addon={<Badge variant="outline-success">ONLINE</Badge>}>
